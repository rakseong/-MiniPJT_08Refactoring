	...
	<tr>
		<td valign="top"> 
			<table  border="0" cellspacing="0" cellpadding="0" width="159">
				...
				<tr>
					<td class="Depth03">
						<a href="/prod/listProduct?menu=manage"  target="rightFrame">판매상품관리</a>
					</td>
				</tr>
				<tr>
					<td class="DepthEnd">&nbsp;</td>
...
<tr>
	<td valign="top"> 
		<table  border="0" cellspacing="0" cellpadding="0" width="159">
			<tr>
				<td class="Depth03">
					<a href="/prod/listProduct?menu=search" target="rightFrame">상 품 검 색</a>
				</td>
			</tr>
			...
			<tr>
				<td class="Depth03">
					<a href="/prch/listPurchase"  target="rightFrame">구매이력조회</a>
				</td>
			</tr>
			</c:if>
